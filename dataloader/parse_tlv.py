...
def readAndParseTLVData(Data, configParameters):
    ...
    # Данные
    detObj, frameData, currentIndex, dataOK = {}, [], 0, 0;
    # Чтение заголовка
    if magicOK: 
        ...
        for tlvIdx in range(Header['numTLVs']):
            ...
            # debug_message(tlv_type, tlv_length, tlvIdx, Header);
            ...
            if dataOK: tmp.append(detObj);
        frameData.append(tmp);
        # Удаление уже обработанных данных
        byteBuffer, byteBufferLength = clear_old_data(byteBuffer, byteBufferLength, totalPacketLen, idX);
    return frameData, Header, dataOK; 